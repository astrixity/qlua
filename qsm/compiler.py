...
from qsm.parser import qsmParser
import ast
...
class qsmCompiler:
    ...
    def _eval_node(self, node):
        ...
        if isinstance(node, QBitDecl):
            ...
            q1 = self._get_or_add_qubit(node.q1)
            q2 = self._get_or_add_qubit(node.q2)
    ...
    def quantum_teleport(self, q1, q2, q3):
        ...
        print(f"[qsm] Quantum teleportation not yet implemented for {q1}, {q2}, {q3}.")
